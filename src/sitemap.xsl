			...
			<body>
				...
				<div id="intro">
					<p>
						...
						This XSLT was generated by <a href="http://www.arnebrachhold.de/">Arne Brachhold</a>.<br/>
						...
						<xsl:for-each select="sitemap:urlset/sitemap:url">
							<tr>
								...
								<td>
									...
									<a href="http://ituland.com/wp-content/plugins/google-sitemap-generator/%7B$itemURL%7D">
										<xsl:value-of select="sitemap:loc"/>
									</a>
								</td>
								<td>
				...
				<div id="footer">
					Generated by <a href="http://www.arnebrachhold.de/">Arne Brachhold</a>. This XSLT template is released under GPL.
				</div>
			</body>
		</html>
	</xsl:template>
